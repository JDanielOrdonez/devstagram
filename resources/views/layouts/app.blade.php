...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bd-gray-100">
            ...
            <div class="container mx-auto flex justify-between items-center">
                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        <a href="{{ route('posts.create') }}" class="flex item-center gap-2 bg-white border p-2 text-gray-600 rounded text-sm uppercase font-bold cursor-pointer">
        ...
        <footer class="text-center p-5 text-gray-500 font-bold uppercase mt-10">
            DevStagram - Todos los derechos reservador 
            {{ now()->year }} 
        </footer>
